...
class App extends Component {
  ...
  /**
   * Modifier le state currentMovie pour lui ajouter un champ qui est son video id.
   */
  applyVideoToCurrentMovie() {
    axios
      .get(
        `${API_END_POINT}movie/${this.state.currentMovie.id}?${API_KEY}&include_adult=false&append_to_response=videos`
      )
      .then(
        function(response) {
